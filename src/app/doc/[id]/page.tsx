    ...
    <div className="min-h-screen bg-white">
      <header className="border-b border-border px-4 py-4 flex items-center gap-3 sticky top-0 bg-white z-40">
        ...
        <div className="ml-auto flex items-center gap-2">
          <button className="rounded-lg border border-border px-3 py-1.5 text-xs text-muted-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="text-muted-foreground mb-6">这是一篇由 TeXpeed AI 排版引擎处理的示例文档。将您的无格式文本粘贴到此处，AI 会自动完成段落切分、层级优化、排版美化与配图生成。</p>
          <h2 className="text-xl font-semibold text-dark mt-8 mb-3">第一章 引言</h2>
          <p className="text-muted-foreground mb-4">TeXpeed 基于 AI 大模型的语义理解能力，能够在 30 秒内将无格式文本蜕变为出版级精美视觉。不同于传统排版工具，TeXpeed 遵循「原文不删改」原则，仅在视觉层面进行优化。</p>
          ...
          <p className="text-muted-foreground mb-4">TeXpeed 让每个人都能轻松拥有专业级排版效果。不必懂设计，不必请编辑，AI 为你完成一切。</p>
        </div>
      </div>
    </div>
  );
